//! Python bindings over `intercom-core`.
//!
//! Messages are ordinary Python values — dicts, lists, strings, numbers, bytes
//! — converted to MessagePack on the way out and back on the way in. Nothing
//! Python-specific is written to the wire, so a service in another language can
//! read what this sends.
...
#[pyclass(name = "Intercom", module = "nitro_intercom._intercom")]
pub struct Intercom {
...
#[pyclass(name = "Listener", module = "nitro_intercom._intercom")]
pub struct Listener {
...
#[pyclass(name = "Reader", module = "nitro_intercom._intercom")]
pub struct Reader {
